...
public class WechatRecoderActivity extends BaseActivity implements MediaRecorderBase.OnErrorListener, MediaRecorderBase.OnEncodeListener {
     ...
     * 视频码率
     */
    public  static int VIDEO_BITRATE_SMALL = 512;
    /**
     * 录制最长时间
     */
    public  static int RECORD_TIME_MAX = 5 * 1000;
    /**
     * 录制最小时间
     */
     ...
     *titel_bar 取消颜色
     */
    private static  int TITEL_BAR_CANCEL_TEXT_COLOR = 0xFF404aff;
     ...
     */
    private static int LOW_MIN_TIME_PROGRESS_COLOR = 0xFFfc28ea;
    /**
     * progress 颜色
     */
...
//        mMediaRecorder.setVideoBitRate(MediaRecorderNative.VIDEO_BITRATE_NORMAL);
        mMediaRecorder.setVideoBitRate(MediaRecorderNative.VIDEO_BITRATE_NORMAL);
