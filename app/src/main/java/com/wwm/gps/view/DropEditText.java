...
public class DropEditText extends EditText implements AdapterView.OnItemClickListener, PopupWindow.OnDismissListener {
    ...
    public PopupWindow mPopupWindow; // 点击图片弹出的popWindow对象
    public ListView mPopListView; // popWindow的布局
    ...
    private void init(Context context) {
        ...
        mDropDrawableResId = R.drawable.drop_down; // 设置下拉图标
        mRiseDrawableResID = R.drawable.drop_down; // 设置上拉图标
